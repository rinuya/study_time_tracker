...
export default function ListviewTable({ activityList }) {
            ...
            <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
                ...
                <div className="overflow-hidden">
                    ...
                    <tbody className="[&>*:nth-child(odd)]:bg-gray-100 [&>*:nth-child(even)]:bg-white">
                        {activityList && sortedList.map(activity => {
                            ...
                            return (
                                ...
                                <td className="text-sm text-gray-900 font-light px-4 sm:px-6 py-4 whitespace-nowrap">
                                    {displayDate}
                                </td>
                                <td className="text-sm text-gray-900 font-light px-4 sm:px-6 py-4 whitespace-nowrap">
                                    {arr_str}
                                ...
                                <td className="text-sm text-gray-900 font-light px-4 sm:px-6 py-4 break-normal overflow-x-auto max-h-6">
